...
function Direct() {
  return (
    <div className="flex flex-col items-center px-20 mt-36 w-full max-md:px-5 max-md:mt-10 max-md:max-w-full">
        ...
        <div className="justify-center self-start px-8 py-6 mt-16 ml-7 text-2xl font-bold bg-white border border-black border-solid rounded-[36px] text-stone-500 max-md:px-5 max-md:mt-10 max-md:ml-2.5">
        ...
        <div className="justify-center self-start px-8 py-5 mt-14 text-2xl font-bold border border-black border-solid bg-stone-500 rounded-[36px] text-stone-200 max-md:px-5 max-md:mt-10 max-md:ml-1.5">
          Book Appointment
        </div>
        </div>
  )
